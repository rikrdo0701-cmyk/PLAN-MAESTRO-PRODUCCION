(function inspectionAppFactory(root) {
  ...
  function renderDetail() {
    ...
    byId("inspectionSecondCapture").innerHTML = `<div class="inspection-grid"><div class="inspection-section-title"></div>${operationHeader()}${operationSubheader("OPER.")}${Array.from({ length: 3 }, () => operationRow({})).join("")}</div>`;
