// ======================================================================
//  OAUTH1.GS – Autenticación y Peticiones NetSuite (REST + SuiteQL)
// ======================================================================
...
//  ✅ Listo para usarse con Google Apps Script
// ======================================================================
...
const NetSuiteOAuth = (() => {
  ...
  function request(method, endpoint, queryParams = {}, body = null) {
    if (!config.accountId)
      throw new Error('⚠️ Debes inicializar NetSuiteOAuth.init(settings) antes de usarlo.');
